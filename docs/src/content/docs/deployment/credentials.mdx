...
- **`android`** — a cookie harvested from the Instagram Android app. FxEmbed sends the app's own `User-Agent`, app id, and `X-IG-Device-ID`, and omits the browser-only headers.
